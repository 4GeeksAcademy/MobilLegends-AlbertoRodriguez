...
const Home = () => {
	...
	const personajesMobilLegends = [
		...
		},
		{
			...
			nombre: "Bruno",
			linea: "Tirador",
			abilidades: ["Piernas mecanicas, Tiro bolea, barrida, Balonazo"],
		...
		},
		{
			...
			nombre: "Grock",
			linea: "Tanque",
			abilidades: ["Control de masas, Poder de la naturaleza,Barrera de Guardian,Embestida"],
		...
		},
		{
			...
			nombre: "Saber",
			linea: "Asesino",
			abilidades: ["Se especializa en enboscadas"],
